...
Holdcall is a local engine. It is a Go binary that runs on a developer's machine,
...
`holdcall_<tag>_<os>_<arch>` archives and a `SHA256SUMS` covering all of them.
